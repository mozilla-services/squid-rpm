...
Source0:  http://www.squid-cache.org/Versions/v3/3.3/squid-%{version}.tar.gz
Source1:  http://www.squid-cache.org/Versions/v3/3.3/squid-%{version}.tar.gz.asc
Source2:  squid.init
...
### KLEIN ### BuildRequires: libdb-devel
# ESI support requires Expat & libxml2
BuildRequires: expat-devel libxml2-devel
# TPROXY requires libcap, and also increases security somewhat
BuildRequires: libcap-devel
# eCAP support
### KLEIN ### BuildRequires: libecap-devel
...
%configure \
   ...
   --with-pidfile='$(localstatedir)/run/squid/squid.pid' \
   --disable-dependency-tracking \
   --enable-eui \
   --enable-follow-x-forwarded-for \
   --enable-auth-basic="LDAP,MSNT,MSNT-multi-domain,NCSA,PAM,SMB,getpwnam,SASL,RADIUS" \
...
%changelog
* Sun Apr 14 2013 Andrew Wyatt <andrew@fuduntu.org> - 7:3.3.3-1
- Built for Fuduntu
- Roll up to latest upstream source

* Mon Feb 06 2012 Henrik Nordstrom <henrik@henriknordstrom.net> - 7:3.1.19-1
- Upstream 3.1.19 bugfix release

* Tue Jan 17 2012 Henrik Nordstrom <henrik@henriknordstrom.net> - 7:3.1.18-1
- upstream 3.1.18 bugfix release

* Mon Oct 31 2011 Henrik Nordstorm <henrik@henriknordstrom.net> - 7:3.1.16-1
- update to latest upstream 3.1.16 fixing invalid free on certain
  DNS responses (Bug #750316)

* Mon Aug 29 2011 Henrik Nordstrom <henrik@henriknordstrom.net> - 7:3.1.15-1
- update to latest upstream 3.1.15 fixing SQUID-2011:3

* Fri Jul 22 2011 Jiri Skala <jskala@redhat.com> - 7:3.1.14-1
- updated to latest upstream 3.1.14

* Thu May 19 2011 Jiri Skala <jskala@redhat.com> - 7:3.1.12-2
- enabled eCAP support

* Thu May 05 2011 Jiri Skala <jskala@redhat.com> - 7:3.1.12-1
